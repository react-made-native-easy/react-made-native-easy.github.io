...
- You only have access to the routes defined in the current stack while navigating. If you try to navigate to a sibling stack from a nested page, you will face an error. To achieve this, you would need to goBack from the index screen of the current stack and then go to the screeen where you want to navigate.
- Use reset action creator to reset/change your navigation dynamically.
- Use redux-middleware for [analytics/screen tracking](https://github.com/react-community/react-navigation/blob/master/docs/guides/Screen-Tracking.md)



>Note: navigation-actions provides us with a lot of other action-creators as well such as back, reset, etc. Please have a look [here](navigation-actions) to know all of them.

The code till here can be found in the **branch** [chapter/10/10.2](https://github.com/master-atul/react-native-plus-plus-code/tree/chapter/10/10.2)
